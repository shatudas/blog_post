   ...
   <div class="row justify-content-center">
    <div class="col-7 rounded-0">
     <div class="card rounded-0">
      ...
      <div class="card-body">
       <form method="POST" action="{{ route('blog.store') }}"  enctype="multipart/form-data" id="myForm">
       @csrf
        <div class="form-row">

         <div class="form-group col-md-12">
          <label for="title"><small>title</small> <span style="color:red;">*</span></label>
          <input type="text" name="title" class="form-control form-control-sm" placeholder="Blog Title">
          <font style="color:red">{{ ($errors->has('title'))?($errors->first('title')):'' }}</font>
         </div>

         <div class="form-group col-md-12">
          <label for="detalis"><small>Detalis</small> <span style="color:red;">*</span></label>
          <textarea name="detalis" class="form-control form-control-sm" id="summernote"></textarea>
         ...
         <div class="form-group col-md-4">
          <img id="showImage" src="{{ url('upload/No-image.jpg') }}" style="width:120px; height:100px; border:1px solid #ccc; float:right">
         </div>
